        ...
        return this.props.cart.map((item, index) => {
            return (
                <tr className="box-cart">
                                ...
                                return (
                                    <div >
                                        <tr>
                                            ...
                                            <td style={{ width: '40%', alignContent: 'center', paddingLeft: '20px', textAlign: 'center' }}>
                                                <span style={{ width: '80%', display: 'flex', alignItems: 'center', height: '100%' }}>
                                                    <Button onClick={() => this.DecrementQty(idx, index, el.price, el.idparcel_type)} class="material-icons"
                                                        style={{
                                                            position: 'relative',
                                                            right: '10px'
                                                        }}
                                                    ...
                                                    <Input size="sm" placeholder="qty" style={{ width: '80%', display: 'inline-block' }}
                                                        innerRef={elemen => this.addQty = elemen} value={el.amount} />
                                                    <Button onClick={() => this.incrementQty(idx, index, el.idcategory, el.price, el.idparcel_type)} class="material-icons"
                                                        style={{
                                                            position: 'relative',
                                                            left: '10px'
                                                        }}
                    ...
                    <td>
                        <Button outline className="bttn-edit" size="sm"
                            onClick={() => this.getParcelType(index)}>
                            <span class="material-icons" size="18dp" >
                                Edit
                            </span>
                        </Button> <br />
                        <Button outline className="bttn-delete" size="sm"
                        ...
                        <div className="col-md-3 mt-5">
                            <div className="box-sum">
                                ...
                                <div className="sum-total">
                                    <h6 className="h6-total">Total </h6>
                                    ...
                                    <Link
                                        ...
                                        to={
                                            this.totalQty() === this.props.cart.length * 5 ?
                                                `/checkout/${this.props.id}` : false}>
                                        <button className="bttn-checkout">
                                            Beli ({this.totalQty()})
                                        </button>
                                    </Link>
                                </div>
