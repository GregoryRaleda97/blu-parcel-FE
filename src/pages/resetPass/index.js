...
import Forget from '../../asset/img/reset.png';
                        ...
                        if (newPass === confirmPass) {
                            ...
                            axios.patch(URL_API + `/auth/update-pass`, { email: email, password: newPass })
                                .then(res => {
                                    ...
                                    toast.success('Your account has been updated!', { position: toast.POSITION.TOP_CENTER, autoClose: 3000 })
                ...
                <Container>
                    <Row className="mt-5 box">
                        <Col md="6" className="p-0">
                            <img src={Forget} className="img" alt="forgetpass" />
                        </Col>
                        <Col md="6" className="col2">
                            ...
                            <button onClick={this.forgetPass} className="btncustom1" style={{ position: 'relative', bottom: '15px', left: '0' }}>
                                {this.state.loading === true ? <Ring style={{ alignItems: 'center' }} /> : <span>Submit</span>}
                            </button>
                        </Col>
                    </Row>
                </Container>
