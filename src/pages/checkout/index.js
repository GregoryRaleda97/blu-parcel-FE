        ...
        return this.state.address.map((item, index) => {
            return (
                <div className="box-address">
                    <h4 style={{ fontSize: '12px', letterSpacing: '1px', lineHeight: '16px', color: '#8C8582' }}>Alamat Saya</h4>
                    <p style={{ fontSize: '14px', lineHeight: '20px', width: '385px' }}>
                        <span style={{ fontWeight: 'bold' }}>{item.recipient_name}, </span>
                        <span>{item.address} <span>{item.postal_code}</span></span>
                        <br /><span>{item.phone_number}</span>
                    ...
                    <div style={{ borderTop: '1px dashed #DDDDDD', paddingTop: '10px' }}>
                        <Button onClick={() => this.setState({ selectedIndex: index, destination: item.idcity }, this.getOngkir(item.idcity))} >Select</Button>
                    </div>
                </div>
            )
        })
                            ...
                            <Container>
                                ...
                                <div className="div-alamat">
                                    <p className="p-alamat">
                                        Alamat Tersimpan</p>
                                    <Link to={`/user-profile`} style={{ fontSize: '14px', lineHeight: '18px', color: '#363636', textDecoration: 'none' }}>+Tambah Alamat</Link>
                                </div>
                        ...
                        <div className="col-md-9">
                            <div className="mt-5 box-alamat-fix" >
                                ...
                                <div className="div-alamat2">
                                    <p className="p-my-address">Alamat Saya</p>
                                    <Button className='button-alamat' onClick={() => {
                                ...
                                <div style={{ paddingTop: '8px' }}>
                                    <Link to={`/user-profile`} style={{ textDecoration: 'none solid rgb(54, 54, 54)', fontSize: '14px', color: 'black', fontWeight: 'bold' }}>
                                        Tambah alamat baru
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div className="col-md-3 mt-5">
                            <div className="box-ro">
                                ...
                                <div style={{ paddingTop: '10px' }}>
                                    <Link onClick={this.onBtCheckOut} to={this.state.selectedIndex !== null ? `/user-transaction/${this.props.id}` : false}>
                                        <div className="btn-checkout" style={{ textDecoration: 'none' }}>
                                            PROCEED TO CHECKOUT
                                        </div>
                                    </Link>
                                </div>
