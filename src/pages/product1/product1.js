...
import { Container, Input, Label, Button, CardImg, Modal, ModalBody } from 'reactstrap';
    ...
    getData = () => {
        ...
        return slice.map((item, index) => {
            return <div className="col-md-3 mt-5">
                <Card style={{ boxShadow: '5px 5px 5px #9c9c9c', borderRadius: "20px", backgroundColor: '#f5f5f5' }}>
                    ...
                    <CardContent>
                        ...
                        <Typography gutterBottom component="div" style={{ height: '55px', color:'#e06100' }}>
                                ...
                                <div className="row p-5" style={{
                                    ...
                                    <div className="col-md-7" style={{ color: 'gray', alignSelf: 'center' }}>
                                        <div>
                                            ...
                                            <p>Harga: {item.price.toLocaleString()}</p>
                                        </div>
                                        <div className="d-flex align-item-center">
                                            <Button onClick={() => this.DecrementQty(item.stock)} size="sm">
                                            ...
                                            <Button onClick={() => this.incrementQty(item.stock)} size="sm">
                                                <span class="material-icons" style={{ fontSize: '12px' }}>
                                                    +
                                                </span>
                                            </Button>
                                        </div>
                                        <Button className="select-btn" size="sm" onClick={() => { this.setState({ modalConfirm: !this.state.modalConfirm }) }}>
                                            Select
                                        </Button>
                                    </div>
                                </div>
            ...
            <Container style={{ marginTop: '110px' }}>
                ...
                <div className="row" >
                    ...
                    <div className="col-md-3 mt-3">
                        ...
                        <div>
                            <h2 className=" mt-5 h2-sort">Nama Produk</h2>
                    ...
                    <div className="col-md-9">
                        <div className="div-box-parcel">
                            <h2 className="h2-produk">Blumart - Pilih Produk Kesukaanmu</h2>
