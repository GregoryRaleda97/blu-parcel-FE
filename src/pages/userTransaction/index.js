                ...
                <div className="mt-3 card-box">
                    <div className="row top-judul" >
                        <div className="col-md-6">
                            <h6>{item.invoice}</h6>
                            <p className="order">Order at <span className="parcel">Bluparcel </span>
                        ...
                        <div className="col-md-6">
                            <div className="row d-flex">
                                    ...
                                    <p className="date"><span>Date transaction: {item.date_transaction}</span>
                                        ...
                                        <span>amount: {item.amount}</span> <br /><br />
                                        {
                                            item.idpayment_status === 2 ?
                                                <span style={{ color: '#015ce4' }}>Anda belum melakukan pembayaran, segera lakukan pembayaran</span> :
                                                <span style={{ color: '#015ce4' }}>Thank you for your order</span>
                                        }
                                    </p>
                                </div>
                                <div className="col-md-4">
                                    {
                                        item.idpayment_status !== 2 ?
                                            <button className="btn-payment" onClick={() => this.setState({ selectedIndex: index, modal: !this.state.modal })}>Detail</button>
                                            :
                                            <>
                                                <button className="bttn-paid" onClick={() => this.setState({ selectedIndex: index, modalPaid: !this.state.modalPaid, idtransaksi: item.id })}>
                                                    Paid
                                                </button>
                                                <button className="bttn-detail" onClick={() => this.setState({ selectedIndex: index, modal: !this.state.modal })}>Detail</button>
                                            </>
                                    }
                                </div>
                            </div>
                    ...
                    <Modal isOpen={this.state.modal} toggle={() => { this.setState({ modal: !this.state.modal }) }}>
                        <ModalBody>
                            <div className="detail-box">
                                <h6>{item.invoice}</h6>
                                <p className="order">Order at <span style={{ fontWeight: 'bold', borderRight: '1px solid #DBDBDB', paddingRight: '10px' }}>Bluparcel </span>
                            ...
                            <div className="detail-box">
                                <div>
                                    <div style={{ textAlign: 'center', alignItems: 'center' }}>
                                        ...
                                        <p className="order">Terima kasih telah memilih Blu.com! Silahkan melengkapi proses pembayaran kamu,
                                            agar pesanan kamu dapat segera kami proses.</p>
                                    </div>
                                    <div style={{ border: '1px solid #DDDDDD', alignItems: 'center', backgroundColor: '#f2f2f2' }}>
                                        <div className="row">
                                    ...
                                    <Grid container spacing={1} alignItems="flex-end">
                                        ...
                                        <Grid item xs={2}>
                                            <Button onClick={this.submitPaymentProof} size="sm"  outline>Submit</Button>
                                        </Grid>
                                    </Grid>
                                </div>
                            </div>
