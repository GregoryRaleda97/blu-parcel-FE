...
import Parcel from '../../asset/img/snacks2.jpg';
                        ...
                        <Container>
                            <Row className="box">
                                ...
                                <Col md="6" className="col2">
                                    <h3>Selamat! 🎉🥳</h3>
                                    <h4>Kamu Memilih Paket {this.props.detailParcel.id}</h4>
                                    <h6>Parcel harus terdiri dari {this.props.detailParcel.title}</h6>
